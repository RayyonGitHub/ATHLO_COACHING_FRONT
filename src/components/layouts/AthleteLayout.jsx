...
{/* --- SIDEBAR (ASIDE) --- */}
        <aside className="w-20 lg:w-64 flex flex-col bg-[#1E1E1E] border-r border-[#2D2D2D] transition-all duration-300 z-20">
          {/* Logo figé en haut */}
          <div className="h-20 flex items-center justify-center lg:justify-start lg:px-8 border-b border-[#2D2D2D] shrink-0">
          ...
          <nav className="flex-1 overflow-y-auto custom-scroll mt-6 flex flex-col gap-2 px-3 pb-8">
            ...
            <Link to="/athlete/factures" className={`flex items-center gap-4 px-3 py-3 lg:px-5 lg:py-3 rounded-xl transition-colors group ${isActive('factures') ? 'bg-[#FF6B00]/10 text-[#FF6B00] font-medium' : 'text-gray-400 hover:bg-[#2D2D2D]'}`}>

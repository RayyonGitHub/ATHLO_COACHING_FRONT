...
const Messages = () => {
  ...
  const theme = isAthleteSpace
    ...
    : {
        ...
        leftPanel: 'bg-white border-slate-200',
        rightPanel: 'bg-gray-50',
        ...
        activeConv: 'bg-orange-50 border-orange-200',
        hoverConv: 'hover:bg-slate-50',
        sentBubble: 'bg-[#FF6A00] text-white',
        receivedBubble: 'bg-white border border-slate-200 text-slate-900',

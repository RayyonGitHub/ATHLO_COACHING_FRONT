...
const ResetPassword = () => {
  ...
  const strength = useMemo(() => getPasswordStrength(formData.new_password), [formData.new_password]);
    ...
    <div className="min-h-screen bg-[#0e0e12] text-white antialiased selection:bg-[#ff6a00] selection:text-white relative overflow-hidden">
      <div className="fixed inset-0 z-0">
        <img
          ...
          alt="gym"
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuBlEXMYQ01ehF6DhvcAFKhp5aG7V--4pEa0vlXJKrUkDRytLaUpbx_SaW4rxKW5MT_CjqXlci2jKtUA-CLjDoeQwjdJZwCi0EGnV8VK5AAmxtNajoprUArCSlNodfa4lahXnGo__Wc5Ob39xHhllxJ_e7GW-noNRyojPd09OySrQsbJU6wjOD5PxiN-XlNjN1oWFtWvqB-q8ruF9TUem8FrveEUN_tAvh3G9g0ws6vEIlSHlftq7ZIzmLy8nvaI5qqd_Sea7wKsjjQ"
        />
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center p-6 lg:p-12">
        ...
        <footer className="mt-12 text-center max-w-xs opacity-40">
          <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400">
            © 2024 ATHLO Performance Ecosystem. Tous droits réservés.
          </p>
        </footer>
      </main>
    </div>

...
const CoachCalendar = () => {
    ...
    return (
      ...
      <div className={`fixed inset-0 z-[1000] grid place-items-center bg-slate-900/60 backdrop-blur-sm transition-all duration-300 ${errorModal.show ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
        <div className={`relative bg-white p-8 w-full max-w-sm rounded-3xl shadow-2xl border border-red-100 text-center transform transition-all duration-300 ${errorModal.show ? 'scale-100 translate-y-0' : 'scale-95 translate-y-8'}`}>
          ...
          <h3 className="text-2xl font-black text-slate-900 mb-2">Impossible</h3>
